  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-8">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-10" style={{ borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <span style={{ fontWeight: 800, fontSize: '1.15rem', letterSpacing: '-0.025em', color: '#0F0F0F' }}>
          ...
          <div className="flex flex-col gap-3">
            <h4 style={{ fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#0F0F0F', marginBottom: '0.25rem' }}>
              Capabilities
            </h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.55rem', fontSize: '0.85rem', color: '#4B5563' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6" style={{ fontSize: '0.8rem', color: '#9CA3AF' }}>
          <div className="flex items-center gap-2">
            <span>© {new Date().getFullYear()} Kairos Global Solutions. All rights reserved.</span>
            <span style={{ opacity: 0.4 }}>•</span>
            <span style={{ color: '#6B7280' }}>Kerala, India • Branches: Chennai, Bangalore, Pune</span>
          </div>
