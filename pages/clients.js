  ...
  return (
    <div className="pt-32 pb-16 px-6 max-w-7xl mx-auto w-full">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto text-lg font-medium">Integrated seamlessly with global industry leaders.</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {partners.map((partner, i) => (
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 overflow-hidden p-2">
              <img 
                src={partner.logo} 
                alt={partner.name}
